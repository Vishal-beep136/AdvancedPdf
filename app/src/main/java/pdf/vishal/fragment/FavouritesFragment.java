...
import pdf.vishal.R;
import pdf.vishal.activity.FavouritesActivity;
import pdf.vishal.activity.MainActivity;
import pdf.vishal.customviews.MyCardView;
import pdf.vishal.fragment.texttopdf.TextToPdfFragment;
import pdf.vishal.model.HomePageItem;
import pdf.vishal.util.CommonCodeUtils;

import static pdf.vishal.util.Constants.ADD_IMAGES;
import static pdf.vishal.util.Constants.ADD_IMAGES_KEY;
import static pdf.vishal.util.Constants.ADD_PASSWORD_KEY;
import static pdf.vishal.util.Constants.ADD_PWD;
import static pdf.vishal.util.Constants.ADD_TEXT_KEY;
...
import static pdf.vishal.util.Constants.COMPRESS_PDF;
import static pdf.vishal.util.Constants.COMPRESS_PDF_KEY;
import static pdf.vishal.util.Constants.EXCEL_TO_PDF_KEY;
import static pdf.vishal.util.Constants.EXTRACT_IMAGES;
import static pdf.vishal.util.Constants.EXTRACT_IMAGES_KEY;
import static pdf.vishal.util.Constants.EXTRACT_TEXT_KEY;
import static pdf.vishal.util.Constants.HISTORY_KEY;
import static pdf.vishal.util.Constants.IMAGE_TO_PDF_KEY;
import static pdf.vishal.util.Constants.INVERT_PDF_KEY;
import static pdf.vishal.util.Constants.MERGE_PDF_KEY;
import static pdf.vishal.util.Constants.PDF_TO_IMAGES;
import static pdf.vishal.util.Constants.PDF_TO_IMAGES_KEY;
import static pdf.vishal.util.Constants.QR_BARCODE_KEY;
import static pdf.vishal.util.Constants.REMOVE_DUPLICATE_PAGES_KEY;
import static pdf.vishal.util.Constants.REMOVE_PAGES;
import static pdf.vishal.util.Constants.REMOVE_PAGES_KEY;
import static pdf.vishal.util.Constants.REMOVE_PASSWORD_KEY;
import static pdf.vishal.util.Constants.REMOVE_PWd;
import static pdf.vishal.util.Constants.REORDER_PAGES;
import static pdf.vishal.util.Constants.REORDER_PAGES_KEY;
import static pdf.vishal.util.Constants.ROTATE_PAGES;
import static pdf.vishal.util.Constants.ROTATE_PAGES_KEY;
import static pdf.vishal.util.Constants.SPLIT_PDF_KEY;
import static pdf.vishal.util.Constants.TEXT_TO_PDF_KEY;
import static pdf.vishal.util.Constants.VIEW_FILES_KEY;
import static pdf.vishal.util.Constants.ZIP_TO_PDF_KEY;
