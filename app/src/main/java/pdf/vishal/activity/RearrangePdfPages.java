...
import pdf.vishal.R;
import pdf.vishal.adapter.RearrangePdfAdapter;
import pdf.vishal.util.Constants;
import pdf.vishal.util.DialogUtils;
import pdf.vishal.util.ThemeUtils;

import static pdf.vishal.util.Constants.CHOICE_REMOVE_IMAGE;
import static pdf.vishal.util.Constants.RESULT;
import static pdf.vishal.util.Constants.SAME_FILE;
